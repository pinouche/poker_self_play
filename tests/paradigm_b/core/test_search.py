...
from paradigm_b.core.belief import build_public_tree, initial_reach
from paradigm_b.core.belief.ranges import board_mask
from paradigm_b.core.cfr import CFRConfig, exploitability
from paradigm_b.core.game import LeducHoldem, build_tree
from paradigm_b.core.game.actions import CALL
from paradigm_b.core.search import ContinualResolver, ResolveConfig, SubgameSolver, strategy_map
from paradigm_b.core.search.best_response import RangeBestResponse
from paradigm_b.core.search.evaluate import leaf_reaches, range_values
from paradigm_b.core.search.policy import tabular_policy_from_strategies
from paradigm_b.core.search.subgame import Gadget
from paradigm_b.leduc.value_net import (
    ExactLeafValues,
    NestedLeafValues,
    PBSValueNet,
    ValueNetConfig,
...
from paradigm_b.leduc.value_net.features import INPUT_DIM, encode_batch, encode_pbs
...
def test_range_best_response_matches_the_exact_tree_best_response(
    ...
    from paradigm_b.core.cfr import best_response_value
