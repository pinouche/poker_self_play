...
from paradigm_a.training.replay_buffer import ReplayBuffer, Transition
from paradigm_a.training.self_play import SelfPlayWorker
...
def test_snapshot_reference_bounds_drift_where_current_accumulates_it():
    ...
    from paradigm_a.model.network import masked_log_softmax
...
def test_updates_are_derived_from_transitions_per_update():
    from paradigm_a.config import updates_for_transitions
