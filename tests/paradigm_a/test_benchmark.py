...
from paradigm_a.cli.benchmark import (
    CONFIG_ORDER,
    CONFIGS,
    build_config,
    build_report,
...
def test_every_config_builds_and_is_internally_consistent():
    for name in CONFIGS:
        ...
        from paradigm_a.config import reward_bound, resolve_q_head
...
def test_sweep_configs_hold_out_every_evaluation_baseline():
    ...
    """
    from paradigm_a.cli.benchmark import SWEEP_ALPHAS
...
def test_capacity_configs_vary_only_the_trunk():
    from paradigm_a.cli.benchmark import CAPACITIES, SETTLED_ALPHA
