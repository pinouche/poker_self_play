...
from paradigm_a.model.network import PokerNet
from paradigm_a.representation.action_encoder import apply_temperature, masked_softmax, sample_action
...
def build_opponent_pool(
    ...
    """
    from paradigm_a.evaluation.heuristic_agent import HEURISTIC_AGENTS
    from paradigm_a.evaluation.random_agent import BASELINE_AGENTS
...
class PopulationSelfPlayWorker:
    ...
    def __init__(
        ...
        from paradigm_a.training.population import PolicyLibrary, freeze_policy
    ...
    def generate(self, num_hands: int) -> Tuple[List[Transition], dict]:
        from paradigm_a.training.population import sample_entry_street, sample_game_setup
