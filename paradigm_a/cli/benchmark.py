...
from paradigm_a.config import Config, EnvConfig, ModelConfig, ObsConfig
...
def build_report(root: str, out_prefix: str) -> None:
    from paradigm_a.training.plotting import load_history
...
def draw_plots(summary, cells, archive, out_prefix: str) -> None:
    ...
    from paradigm_a.training.plotting import plot_runs
